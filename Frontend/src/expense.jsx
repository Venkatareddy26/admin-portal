...
export default function ExpensePage(){
  ...
  // Do not seed demo employees here — rely on persisted store or backend
  ...
  function addExpense(){
  const e = { id: uid(), date: newExpense.date || new Date().toISOString().slice(0,10), employeeId: newExpense.employeeId || '', tripId: newExpense.tripId || null, amount: Number(newExpense.amount)||0, category: newExpense.category||'Other', receiptUrl: newExpense.receiptUrl||'', submitted: Boolean(newExpense.receiptUrl), flagged: false };
    setExpenses(s => [e, ...s]);
